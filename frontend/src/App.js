...
import adds1 from "./img/adds-1.jpg";
import adds2 from "./img/adds-2.jpg";
...
import latestnews from "./img/latest-news.jpg";
import popularnews from "./img/popular-news.jpg";
                    ...
                    <div class="col-md-4">
                        <div class="sidebar">
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="image">
                                    <a href=""><img src={adds1} alt="Image" /></a>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="image">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <a href=""><img src={adds2} alt="Image" /></a>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href=""><img src={adds2} alt="Image" /></a>
                                        </div>
